...
public class YourPlaylistFragment extends Fragment implements PlayerStateListener, WPAdapterOptionsListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        wavesPlayerPlaylistAdapter = new WavesPlayerPlaylistAdapter(this, playLists, getActivity(), R.layout.item_wavesplayer_playlist, false);
