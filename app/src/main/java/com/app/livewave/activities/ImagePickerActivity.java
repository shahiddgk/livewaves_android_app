...
import static com.app.livewave.utils.Constants.REQUEST_GALLERY_IMAGE;
...
public class ImagePickerActivity extends AppCompatActivity {
    ...
    private void cropImage(Uri sourceUri) {
        ...
        // applying UI theme
        options.setToolbarColor(ContextCompat.getColor(this, R.color.buttercup));
        options.setStatusBarColor(ContextCompat.getColor(this, R.color.buttercup));
