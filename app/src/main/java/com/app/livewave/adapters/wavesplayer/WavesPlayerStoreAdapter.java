...
public class WavesPlayerStoreAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ArrayList<Track> songArrayList;
    Activity activity;
    boolean isSummarized;
    WPAdapterOptionsListener optionsListener;

    public WavesPlayerStoreAdapter(WPAdapterOptionsListener optionsListener, ArrayList<Track> songArrayList, Activity activity, boolean isSummarized) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemeView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_wavesplayer_store, parent, false);
        RecyclerView.ViewHolder holder = new Holder(itemeView, activity);
    ...
    public int getItemCount() {
        return isSummarized ? songArrayList.size() > 3 ? 2 : songArrayList.size() : songArrayList.size();//songArrayList.size();
    }
